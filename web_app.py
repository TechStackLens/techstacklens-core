    ...
    if request.method == 'POST':
        ...
        if 'iis' in selected_stacks:
            ...
            if 'cloud' in selected_stacks:
                with open('techstacklens/scanner/cloud_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'lamp' in selected_stacks:
                with open('techstacklens/scanner/lamp_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'tomcat' in selected_stacks:
                with open('techstacklens/scanner/tomcat_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'jboss' in selected_stacks:
                with open('techstacklens/scanner/jboss_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'xampp' in selected_stacks:
                with open('techstacklens/scanner/xampp_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'nodejs' in selected_stacks:
                with open('techstacklens/scanner/nodejs_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'react' in selected_stacks:
                with open('techstacklens/scanner/react_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'kubernetes' in selected_stacks:
                with open('techstacklens/scanner/kubectl_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            if 'docker' in selected_stacks:
                with open('techstacklens/scanner/docker_scanner.py', 'r') as f:
                    script_lines.append(f.read())
            script_lines.append("")
